...
| #17 | Frontend nije imao committed e2e suite — brojke „N/N" bile su ručne verifikacije. | **5.6** · 4 | 🟡 otvoren | 🔴 **bez brojke** |
| #18 | BKT povijest je rekurzivan lanac: brisanje iz sredine invalidira sve kasnije točke. | **5.5** · 4 | ✅ popravljen | 🔴 **bez brojke** |
...
| #29 | Rezultatska evaluacija ne razlikuje ekvivalentne formulacije — BKT kredit bez upotrebe koncepta. | **5.5** | 📌 prihvaćena limitacija | 🔴 **bez brojke** |
...
| #39 | `make dev-reset` guard odbijao je i ispravnu potvrdu jer `docker compose exec` jede stdin. | **5.6** · nijedno | ✅ popravljen | 🔴 **bez brojke** |
...
| #58 | Uklanjanje trenja iz ponovnog pokušaja može promijeniti raspodjelu uzastopnih predaja. | **5.6** · 6 | 🟡 otvoren | 🔴 **bez brojke** |
...
| #78 | Gate diskriminacije pokriva samo zadatke koje je autorska skripta napisala. | **5.6** · 3 | 🟡 otvoren | 🔴 **bez brojke** |
...
### A. Traže mjerenje prije nego uđu u tekst — 6 nalaza

Svi su u empirijskim poglavljima (5.5 / 5.6), gdje se tvrdnja bez brojke ne može obraniti.

| broj | težište | što nedostaje |
|---|---|---|
| #17 | 5.6 | Tvrdi da su brojke „N/N" iz faza 4.1–4.3 bile ručne verifikacije, ali **ne kaže koliko ih je bilo ni koliko ih je e2e suite naknadno pokrio**. Bez toga se u 5.6 ne može reći koliko je provjere zapravo nedostajalo. |
| #18 | 5.5 | Pravilo o rekurzivnom lancu je točno, ali **nijedan broj ne kaže koliko je lanac dubok** u stvarnim podacima. Prolaz 5.3 daje kandidata: 339 točaka / 29 koncepata. |
| #29 | 5.5 | **Najteži izostanak na popisu.** Tvrdi da je „savladanost spuriozna" sustavno, a ima **jedan ilustrativni zadatak i nijednu mjeru opsega**. Mjerljivo je: za koliko od 88 zadataka postoji alternativna formulacija koja prolazi. Bez te brojke tvrdnja u 5.5 ostaje anegdota. |
| #39 | 5.6 | Poučak („guard netestiran u oba smjera nije guard") je jak, ali **nema brojke** — ni koliko je guardova u projektu, ni koliko ih je testirano oba smjera. Kandidat za fusnotu uz #57. |
| #58 | 5.6 | Predviđa učinak na raspodjelu uzastopnih predaja i **sam propisuje mjerenje** („izračunati udio identičnih uzastopnih `submitted_query`") — koje nikad nije izvedeno. Podaci prolaza 5.3 to sada omogućuju. |
| #78 | 5.6 | Tvrdi da gate pokriva samo autorske zadatke, ali **ne kaže koliko ih je izvan njega** (spominje samo zadatak 81). Opseg je trivijalno prebrojiv. |

🔴 **#29 je prioritet.** Na njega se poziva pet drugih nalaza (#35, #45, #54, #58, #66) kao
na temeljnu prijetnju konstruktnoj valjanosti, a sam nema nijednu mjeru opsega. Ako ijedno
mjerenje još treba izvesti, ovo je to.
