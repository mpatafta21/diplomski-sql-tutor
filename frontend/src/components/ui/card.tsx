  ...
  return (
    <div
      ...
      className={cn(
        ...
        // ⟳ glađi hover (korisnik, 2026-08-10): fast → base (160 → 240 ms).
        "transition-[transform,box-shadow] duration-base ease-standard hover:-translate-y-0.5 hover:shadow-lg motion-reduce:hover:translate-y-0",
        className
      )}
      {...props}
    />
